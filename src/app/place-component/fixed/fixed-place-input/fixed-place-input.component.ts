...
@Component({
  selector: 'sb-fixed-place-input',
  templateUrl: './fixed-place-input.component.html',
  styleUrls: ['./fixed-place-input.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => FixedPlaceInputComponent),
      multi: true
    },
    {
...
export class FixedPlaceInputComponent extends Unsubscribable implements OnInit, OnDestroy, ControlValueAccessor, Validator {
  @Input()
  readonly = false;
  ...
  place: FormGroup = new FormGroup({
    ...
    oi: new FormControl(new Date().getMilliseconds())
  });
